...
## Why I'm Not Hype:
Projecting myself into Thorkell's position: Even if I had the same inkling that he felt in that moment --  that Canute and my old friend Thors were tapping into the same source of wisdom that I sought -- I can think of a multitude of reasons why I would not make the same decision that Thorkell made:
1. **Fear**: Following Canute would mean willingly putting myself into a less favorable position in the war. What if I die? What if I fail? What if I'm left in ruins or some other unrecoverable state?
2. **Doubt**: I'd be basing this life threatening commitment on a feeling that Canute is reminding me of someone else. What if I'm just flat out wrong? Canute could be sourcing his confidence from a source totally distinct from Thors' source. Am I really going to make such a commitment based on a feeling?
3. **Personal Track Record**: I have a long history of NOT making decisive, impactful decisions when working with incomplete information. In high-stakes decisions, I assign a high weighting to my current path, and demand overwhelming consensus before adjusting course. This ingrained behavioral pattern would conspire very effectively with the prior two points to keep me on my original course.
4. **Optionality**: Being the strongest human alive and a hyper-competent war veteran affords a large degree of freedom (I'm speaking about Thorkell here, not myself, in case that wasn't clear 🥲). Thorkell posses rare and valuable skills that ensures a wide variety of favorable opportunities will remain available, regardless of the outcome from any one decision (excluding the outcome of death). I myself have no such stand-out skills that would secure desirable opportunities irrespective of short-term outcomes.
5. **Dependencies:** Thorkell lives such a highly-aligned, simplified lifestyle that he's not bound by external dependencies and is therefore free to decisively change his life's trajectory in an instant. My desires and goals are intertwined with commitments I've made to others, primarily my wife and future family. While this dependency could certainly be used as a cop-out, it's also real. I cannot quit my job to join a monastery and become a monk without violating promises to my wife.

## How does one do something like that?
![[how_does_one_do_something_like_that.gif]]

The following is my personalized Thorkellmaxxing Protocol.
...
The problem is that I've trained myself, through years of repetition, to treat "I'm not 100% sure" as a valid stop signal. That threshold needs to come down, but I can't just lower it by decree. I need reps.
1. **Low-stakes intuition practice** - When I catch myself researching a decision that doesn't warrant research, I'll cut the research short and go with my gut. This should build the muscle of acting on partial signals
2. **Name the threshold** -  If I feel stuck, I can expose my researching and pondering for the stall tactic that it (likely) is with a question: "What level of certainty am I aiming for and is that level realistically attainable?" Forcing myself to define my required level of certainty should shed light on instances where I'm stalling vs genuinely thinking through a decision.
...
I want to have my own Thorkell moment. I don't care what it's about or when it happens, but I want to confidently make an authentic decision that shocks friends and family, and invigorates my soul. I don't particularly care if the decision leads to a good or bad outcome. Additionally, I want to consciously identify the decision as a "Thorkell Moment"; post hoc identification is fine too.

If I live out my years, *"Thorkell moment"-less*, that will be disappointing, but acceptable. I don't believe Thorkell moments can be willed into existence, as the appearance of the opportunity is somewhat luck based. If I can be so lucky as to encounter such an opportunity, I hope only that I am prepared enough to make myself proud.